    ...
    def _build_source_registry() -> List[Dict[str, Any]]:
        return [
            ...
            },
            {
                ...
                "role": "biomedical literature search, identifiers, annotations, and open-access metadata",
                "status": "planned",
            ...
            },
            {
                ...
                "source_kind": "database_entry",
                "sync_mode": "periodic_api_sync",
                "role": "open-access full text retrieval for evidence-bearing extraction",
                "status": "planned",
